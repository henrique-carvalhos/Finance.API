...
namespace Finance.Application.Models
{
    ...
    {
        public ExpenseViewModel(int id, string description, decimal amount, DateTime dateExpense, string nameUser, string nameExpenseCategory, string nameExpenseType)
        {
            Id = id;
        ...
        public static ExpenseViewModel FromEntity(Expense expense)
            => new(expense.Id, expense.Description, expense.Amount, expense.DateExpense, expense.User.Name, expense.ExpenseCategory.Name, expense.ExpenseType.Name);
    }
}
